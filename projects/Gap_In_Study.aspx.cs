...
namespace Project
{
    public partial class Gap_In_Study : System.Web.UI.Page
    {
        ...
        protected void Btn_Save_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand Updatecmd = new SqlCommand("Insert_Gap_In_Study", conn);
                Updatecmd.CommandType = CommandType.StoredProcedure;
            Updatecmd.Connection = conn;
            //Updatecmd.CommandText = "insert into Gap_In_Study(USN,Year,Class,Description,Is_Active,Updated_Date,Updated_By)Values(@USN,@Year,@Class,@Description,@Is_Active,@Updated_Date,@Updated_By)";
            Updatecmd.Parameters.AddWithValue("@USN", SqlDbType.VarChar).Value = Txt_USN.Text.Trim();
            Updatecmd.Parameters.AddWithValue("@Year", SqlDbType.Int).Value = Txt_Year.Text.Trim();
            Updatecmd.Parameters.AddWithValue("@Class", SqlDbType.Int).Value = Txt_class.Text.Trim();
            Updatecmd.Parameters.AddWithValue("@Description", SqlDbType.VarChar).Value = Txt_dscption.Text.Trim();
