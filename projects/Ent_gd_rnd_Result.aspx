<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Ent_gd_rnd_Result.aspx.cs" Inherits="Project.Ent_gd_rnd_Result" %>
...
<fieldset ><legend>Entry GD Round Result</legend>
...
<fieldset><legend>Entry FStudent</legend>
<table cellpadding="3px" cellspacing="3px">
    ...
    <tr>
        ...
        <td>
            <asp:CheckBox ID="Check_gd" runat="server" Text="Group_Discussion" />
        </td>
        
        <td>
            <asp:CheckBox ID="Check_tPhone1" runat="server" Text="Telephone_Interview1" />
        </td>
        <td>
            <asp:CheckBox ID="Check_tPhone2" runat="server" Text="Telephone_Interview2" />
        </td>
    ...
    <tr>
        ...
        <td>
            <asp:DropDownList ID="DropDown_companyName" CssClass="dropdownbox" 
                runat="server" 
                onselectedindexchanged="DropDown_companyName_SelectedIndexChanged">
            </asp:DropDownList>
        </td>
    </tr>
