<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Pool_Campus_Eligible_Student.aspx.cs" Inherits="Final_Report_SMPS.Pool_Campus_Eligible_Student" %>
...
<table style="height: 181px; width: 307px"> 
    ...
    <tr>
        ...
        <td class="style1">
            ...
            <asp:RequiredFieldValidator ID="StudentIdValidator" runat="server" Text="**" 
    ...
    <tr>
     ...
     <td>
     <asp:RadioButton ID="m" runat="server" Text="M" GroupName="Gender" />
         <asp:RadioButton ID="f" runat="server" Text="F" 
             GroupName="Gender" />
    ...
    <tr>
     ...
     <td>
     <asp:RadioButton ID="Rdyes" runat="server" Text="Yes" GroupName="Address" 
             AutoPostBack="True" oncheckedchanged="Rdyes_CheckedChanged" />
         <asp:RadioButton ID="RdNo" runat="server" Text="No" GroupName="Address" 
             AutoPostBack="True" />
...
<td>
    ...
    <td><asp:Button ID="BtnHome" runat="server"    Text="Home" ValidationGroup="hm" 
            onclick="BtnHome_Click" CssClass="buttonsimg" />
      </td> 
