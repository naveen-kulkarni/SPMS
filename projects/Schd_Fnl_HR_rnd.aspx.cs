...
namespace Project
{
    public partial class Schd_Fnl_HR_rnd : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            //string queryString = "insert into Schedule_Final_HR_Round(USN,CompanyId,Test_Date,Test_Time,Test_Place,Test_Type,Description,Is_Active,Updated_Date,Updated_By)values(@USN,@CompanyId,@Test_Date,@Test_Time,@Test_Place,@Test_Type,@Description,@Is_Active,@Updated_Date,@Updated_By)";
            //SqlCommand Updatecmd = new SqlCommand(queryString, conn);

           // Updatecmd.CommandType = CommandType.Text;
            SqlCommand Updatecmd = new SqlCommand("Save_Schedule_Final_HR_Round", conn);
        ...
        protected void Btn_del_Click(object sender, EventArgs e)
        {
            ...
            string queryString = "Update Schedule_Final_HR_Round set Is_Active=0 where USN= @USN";
