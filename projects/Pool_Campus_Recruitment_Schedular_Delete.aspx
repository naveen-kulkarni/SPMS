<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Pool_Campus_Recruitment_Schedular_Delete.aspx.cs" Inherits="Final_Report_SMPS.Pool_Campus_Recruitment_Schedular_Delete" %>
...
<table> 
       ...
       <tr> <td>
        ...
        <td class="style1">
         ...
         <td>
    <asp:Button ID="BtnDelete" runat="server" Text="Delete" onclick="BtnDelete_Click"  CssClass="buttonsimg"  />
    </td>
