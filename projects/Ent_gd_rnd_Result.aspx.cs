...
namespace Project
{
    public partial class Ent_gd_rnd_Result : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            //Updatecmd.Connection = conn;
            //Updatecmd.CommandText = "insert into Wrt_Tst_Result(GroupDiscussion)Values(@GroupDiscussion)";
            // Updatecmd.CommandText = "update Wrt_Tst_Result set GroupDiscussion=@GroupDiscussion,telephone_interview1=@telephone_interview1,telephone_interview2=@telephone_interview2,Description=@Description,Updated_Date=@Updated_Date,Updated_By=@Updated_By where USN=@USN AND CompanyId=@CompanyId";
            Updatecmd.Parameters.AddWithValue("@USN", SqlDbType.VarChar).Value = Text_USN.Text.Trim();
            Updatecmd.Parameters.AddWithValue("@GroupDiscussion", Check_gd.Checked);
            Updatecmd.Parameters.AddWithValue("@telephone_interview1", Check_tPhone1.Checked);
            Updatecmd.Parameters.AddWithValue("@telephone_interview2", Check_tPhone2.Checked);
